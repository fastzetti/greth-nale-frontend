...
export default function Impressum() {
  return (
    <Layout title="Impressum | Datenschutz">
      ...
      <p>
        <span id="s3-t-firma">
          GretherKultur in Zusammenarbeit mit der Buchhandlung jos fritz.
        </span>
        <br />
        <span id="s3-t-ansprechpartner">www.grether.syndikat.org</span>
        <br />
        <span id="s3-t-strasse">Adlerstr. 12</span>
        <br />
        <span id="s3-t-plz">79098</span> <span id="s3-t-ort">Freiburg</span>
      </p>
      <p></p>
      <p>
